...
public class Main {
	public static void main(String[] args) throws Exception {
		ArrayList<Integer> numbers = new ArrayList<Integer>(Arrays.asList(-10,-3,0,3,7,11,18,25,32,50,125,175,200,500));
		ArrayList<Integer> numbers1 = new ArrayList<Integer>(Arrays.asList(190,-3,0,141,18,-55,-90,92,200,-150,11,80,-65,90));
